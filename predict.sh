...
deltaweight1=`echo "scale=10; ($deltaoutput / $hiddensum1)" | bc`
deltaweight2=`echo "scale=10; ($deltaoutput / $hiddensum2)" | bc`
deltaweight3=`echo "scale=10; ($deltaoutput / $hiddensum3)" | bc`
...
newhiddensum1=`echo "scale=10; (($deltaoutput / $weight7) * $deltahiddensum1)" | bc` 
newhiddensum2=`echo "scale=10; (($deltaoutput / $weight8) * $deltahiddensum2)" | bc`
newhiddensum3=`echo "scale=10; (($deltaoutput / $weight9) * $deltahiddensum3)" | bc`
deltaweightin1=`echo "scale=10; ($newhiddensum1 / $input1)" | bc`
deltaweightin2=`echo "scale=10; ($newhiddensum2 / $input1)" | bc`
deltaweightin3=`echo "scale=10; ($newhiddensum3 / $input1)" | bc`
deltaweightin4=`echo "scale=10; ($newhiddensum1 / $input2)" | bc`
deltaweightin5=`echo "scale=10; ($newhiddensum2 / $input2)" | bc`
deltaweightin6=`echo "scale=10; ($newhiddensum3 / $input2)" | bc`
newweight1=`echo "scale=10; ($weight1 + $deltaweightin1)" | bc`
newweight2=`echo "scale=10; ($weight2 + $deltaweightin2)" | bc`
newweight3=`echo "scale=10; ($weight3 + $deltaweightin3)" | bc`
newweight4=`echo "scale=10; ($weight4 + $deltaweightin4)" | bc`
newweight5=`echo "scale=10; ($weight5 + $deltaweightin5)" | bc`
newweight6=`echo "scale=10; ($weight6 + $deltaweightin6)" | bc`
